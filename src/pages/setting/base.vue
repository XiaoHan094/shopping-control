        ...
        <el-tabs v-model="activeName" >
            <el-tab-pane label="注册与访问" name="first">
                ...
                <el-form-item label="密码最小长度">
                    <el-input v-model="form.password_min" placeholder="密码最小为7位" size="normal" style="width:300px;" ></el-input>
                </el-form-item>
...
function getData(){
    ...
    form.password_encrypt = form.password_encrypt.split(",")//将传过来的密码选项变为数组
...
const submit = ()=>{
  ...
  setSysconfig({
    ...form,
    password_encrypt:form.password_encrypt.join(",")//通过join转成字符串
  }).then(res=>{
    toast("修改成功")
    getData()
  }).finally(()=>{
