<template>
    <!-- 设置商品详情 -->
    <FormDrawer ref="formDrawerRef" title="设置商品规格" @submit="submit" size="70%" destroy-on-close>
        <el-form :model="form">
...
// 准备接受传过来的商品id,这个在useSku里面已经引入了，所以就不用再定义了
// const goodsId = ref(0)
...
const open = (row) => {
    ...
    readGoods(goodsId.value).then(res => {
        // console.log(res)
        form.sku_type = res.sku_type//用来判断是多规格还是单规格
        ...
        initSkuCardList(res)//获取商品规格信息，在useSku.js里面封装了,这边res是传入当前对象
